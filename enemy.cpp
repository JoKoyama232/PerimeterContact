...
#define	MODEL_ENEMY_PARTS	"data/MODEL/funnel_f.obj"
#define	MODEL_ENEMY_PARTS_s	"data/MODEL/funnel_s.obj"
...
HRESULT InitEnemy(void)
{
	for (int i = 0; i < MAX_ENEMY; i++)
	{
		...
		//		//canon head
		//		{
		//			LoadModel(MODEL_ENEMY, &g_Parts[j].model, true);
		//			g_Parts[j].load = true;
		//			g_Parts[j].pos = XMFLOAT3(20.0f, ENEMY_OFFSET_Y, -20.0f);
		//			g_Parts[j].rot = XMFLOAT3(0.0f, XM_PI, 0.0f);
		...
		//		//canon barrel
		//		{
		//			LoadModel(MODEL_ENEMY, &g_Enemy[i + 4].model, true);
		//			g_Parts[j].load = true;
		//			g_Parts[j].pos = XMFLOAT3(20.0f, ENEMY_OFFSET_Y, -20.0f);
		//			g_Parts[j].rot = XMFLOAT3(0.0f, XM_PI, 0.0f);
		//			g_Parts[j].scl = XMFLOAT3(1.0f, 1.0f, 1.0f);
